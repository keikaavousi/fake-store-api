...
/*!
 * Module exports.
 */t.exports=n,n.messages=r(124),n.Messages=n.messages,n.DocumentNotFoundError=r(125),n.CastError=r(13),n.ValidationError=r(29),n.ValidatorError=r(70),n.VersionError=r(126),n.ParallelSaveError=r(127),n.OverwriteModelError=r(128),n.MissingSchemaError=r(129),n.DivergentArrayError=r(130),n.StrictModeError=r(30)},function(t,e,r){"use strict";
/*!
...
/*!
 * ignore
 */(e):{};if(null==this._doc&&(this.$__buildDoc(t,e,r,d,y,!1),Y(this,e,r,d,y,!0,{isNew:this.isNew})),t&&(this.$__original_set?this.$__original_set(t,void 0,!0):this.$set(t,void 0,!0),t instanceof W&&(this.isNew=t.isNew)),n.willInit?s.prototype.once.call(this,"init",function(){Y(o,e,r,d,y,!1,n.skipDefaults,o.isNew)}):Y(this,e,r,d,y,!1,n.skipDefaults,this.isNew),this.$__._id=this._id,this.$locals={},this.$op=null,!c.options.strict&&t){var v=this;Object.keys(this._doc).forEach(function(t){t in c.tree||w(t,null,v)})}!
/*!
 ...
 * ignore
 */
function K(t,e){var r=new Set(e),n=new Map([]),i=!0,o=!1,s=void 0;try{for(var a,u=e[Symbol.iterator]();!(i=(a=u.next()).done);i=!0){var c=a.value;if(-1!==c.indexOf("."))for(var l=c.split("."),f=l[0],h=1;h<l.length;++h)n.set(f,c),f=f+"."+l[h]}}catch(t){o=!0,s=t}finally{try{!i&&u.return&&u.return()}finally{if(o)throw s}}var p=[],d=!0,y=!1,v=void 0;try{for(var _,m=t[Symbol.iterator]();!(d=(_=m.next()).done);d=!0){var g=_.value;r.has(g)?p.push(g):n.has(g)&&p.push(n.get(g))}}catch(t){y=!0,v=t}finally{try{!d&&m.return&&m.return()}finally{if(y)throw v}}return p}
/*!
 * Applies virtuals properties to `json`.
 */
function Q(t,e,r,n){var i=t.schema,o=Object.keys(i.virtuals),s=o.length,a=s,u=void 0,c=void 0,l=t._doc,f=void 0,h=S(n,"aliases",!0);if(!l)return e;for(r=r||{},s=0;s<a;++s)if(u=o[s],h||!i.aliases.hasOwnProperty(u)){if(c=u,null!=r.path){if(!u.startsWith(r.path+"."))continue;c=u.substr(r.path.length+1)}var p=c.split(".");if(void 0!==(f=T(t.get(u),r))){var d=p.length;l=e;for(var y=0;y<d-1;++y)l[p[y]]=l[p[y]]||{},l=l[p[y]];l[p[d-1]]=f}}return e}
/*!
 * Applies virtuals properties to `json`.
 *
 * @param {Document} self
 * @param {Object} json
 * @return {Object} `json`
 */W.prototype.schema,Object.defineProperty(W.prototype,"$locals",{configurable:!1,enumerable:!1,writable:!0}),W.prototype.isNew,W.prototype.id,W.prototype.errors,W.prototype.$op,W.prototype.$__buildDoc=function(t,e,r,n,i){for(var o={},s=Object.keys(this.schema.paths).filter(function(t){return!t.includes("$*")}),a=s.length,u=0;u<a;++u){var c=s[u];if("_id"===c){if(r)continue;if(t&&"_id"in t)continue}for(var l=c.split("."),f=l.length,h=f-1,p="",d=o,y=!1,v=0;v<f;++v){var _=l[v];if(p+=(p.length?".":"")+_,!0===n){if(p in e)break}else if(!1===n&&e&&!y)if(p in e)y=!0;else if(!i[p])break;v<h&&(d=d[_]||(d[_]={}))}}this._doc=o},
/*!
 * Converts to POJO when you use the document for querying
 */
W.prototype.toBSON=function(){return this.toObject(N)},W.prototype.init=function(t,e,r){return"function"==typeof e&&(r=e,e=null),this.$__init(t,e),r&&r(null,this),this},
/*!
 * ignore
 */
W.prototype.$__init=function(t,e){if(this.isNew=!1,this.$init=!0,e=e||{},null!=t._id&&e.populated&&e.populated.length)for(var r=String(t._id),n=0;n<e.populated.length;++n){var i=e.populated[n];i.isVirtual?this.populated(i.path,k.getValue(i.path,t),i):this.populated(i.path,i._docs[r],i)}
/*!
 * Init helper.
 *
 ...
 */
function(t,e){if(null==t._id||null==e||0===e.length)return;var r=String(t._id),n=!0,i=!1,o=void 0;try{for(var s,a=e[Symbol.iterator]();!(n=(s=a.next()).done);n=!0){var u=s.value;if(!u.isVirtual)for(var c=u.path,l=c.split("."),f=0;f<l.length-1;++f){var h=l.slice(0,f+1).join("."),p=l.slice(f+1).join("."),d=t.get(h);if(null!=d&&d.isMongooseDocumentArray){for(var y=0;y<d.length;++y)d[y].populated(p,null==u._docs[r]?[]:u._docs[r][y],u);break}}}}catch(t){i=!0,o=t}finally{try{!n&&a.return&&a.return()}finally{if(i)throw o}}}(this,e.populated),this.emit("init",this),this.constructor.emit("init",this),this.$__._id=this._id,this},W.prototype.update=function(){var t=k.args(arguments);t.unshift({_id:this._id});var e=this.constructor.update.apply(this.constructor,t);return null!=this.$session()&&("session"in e.options||(e.options.session=this.$session())),e},W.prototype.updateOne=function(t,e,r){var n=this,i=this.constructor.updateOne({_id:this._id},t,e);return i._pre(function(t){n.constructor._middleware.execPre("updateOne",n,[n],t)}),i._post(function(t){n.constructor._middleware.execPost("updateOne",n,[n],{},t)}),null!=this.$session()&&("session"in i.options||(i.options.session=this.$session())),null!=r?i.exec(r):i},W.prototype.replaceOne=function(){var t=k.args(arguments);return t.unshift({_id:this._id}),this.constructor.replaceOne.apply(this.constructor,t)},W.prototype.$session=function(t){if(0===arguments.length)return this.$__.session;if(this.$__.session=t,!this.ownerDocument){var e=this.$__getAllSubdocs(),r=!0,n=!1,i=void 0;try{for(var o,s=e[Symbol.iterator]();!(r=(o=s.next()).done);r=!0){o.value.$session(t)}}catch(t){n=!0,i=t}finally{try{!r&&s.return&&s.return()}finally{if(n)throw i}}}return t},W.prototype.overwrite=function(t){var e=Array.from(new Set(Object.keys(this._doc).concat(Object.keys(t)))),r=!0,n=!1,i=void 0;try{for(var o,s=e[Symbol.iterator]();!(r=(o=s.next()).done);r=!0){var a=o.value;"_id"!==a&&(this.schema.options.versionKey&&a===this.schema.options.versionKey||this.$set(a,t[a]))}}catch(t){n=!0,i=t}finally{try{!r&&s.return&&s.return()}finally{if(n)throw i}}return this},W.prototype.$set=function(t,e,r,n){var s=this;k.isPOJO(r)&&(n=r,r=void 0);var a=(n=n||{}).merge,f=r&&!0!==r,h=!0===r,p=void 0,y=0,v=void 0,_=void 0,m=void 0,b="strict"in n?n.strict:this.$__.strictMode;if(f&&((this.$__.adhocPaths||(this.$__.adhocPaths={}))[t]=this.schema.interpretAsType(t,r,this.schema.options)),"string"!=typeof t){if(t instanceof W&&(t=t.$__isNested?t.toObject():t._doc),null!=t){m=e?e+".":"";var w=(p=Object.keys(t)).length,O=S(n,"_skipMinimizeTopLevel",!1);if(0===w&&(!this.schema.options.minimize||O))return delete n._skipMinimizeTopLevel,e&&this.$set(e,{}),this;for(;y<w;)$.call(this,y++);return this}var A=t;t=e,e=A}else this.$__.$setCalled.add(t);function $(e){_=p[e];var o=m+_;if(v=this.schema.pathType(o),!0!==r||m||null==t[_]||"nested"!==v||null==this._doc[_]||0!==Object.keys(this._doc[_]).length||(delete this._doc[_],n=Object.assign({},n,{_skipMinimizeTopLevel:!0})),"object"!==i(t[_])||k.isNativeObject(t[_])||k.isMongooseType(t[_])||null==t[_]||"virtual"===v||"real"===v||this.$__path(o)instanceof c||this.schema.paths[o]&&this.schema.paths[o].options&&this.schema.paths[o].options.ref)if(b){if(h&&void 0===t[_]&&void 0!==this.get(_))return;if("adhocOrUndefined"===v&&(v=E(this,o,{typeOnly:!0})),"real"===v||"virtual"===v){var s=t[_];this.schema.paths[o]&&this.schema.paths[o].$isSingleNested&&t[_]instanceof W&&(s=s.toObject({virtuals:!1,transform:!1})),this.$set(m+_,s,h,n)}else if("nested"===v&&t[_]instanceof W)this.$set(m+_,t[_].toObject({transform:!1}),h,n);else if("throw"===b)throw"nested"===v?new l(_,t[_]):new d(_)}else void 0!==t[_]&&this.$set(m+_,t[_],h,n);else this.$__.$setCalled.add(m+_),this.$set(t[_],m+_,h,n)}var j=this.schema.pathType(t);if("adhocOrUndefined"===j&&(j=E(this,t,{typeOnly:!0})),k.isPOJO(e)&&null!=e.$__&&null!=e._doc&&(e=e._doc),"nested"===j&&e){if("object"===(void 0===e?"undefined":i(e))&&null!=e){if(a)return this.$set(e,t,h);this.$__setValue(t,null),g(this,t);var x=Object.keys(e);this.$__setValue(t,{});var N=!0,T=!1,B=void 0;try{for(var C,D=x[Symbol.iterator]();!(N=(C=D.next()).done);N=!0){var M=C.value;this.$set(t+"."+M,e[M],h)}}catch(t){T=!0,B=t}finally{try{!N&&D.return&&D.return()}finally{if(T)throw B}}return this.markModified(t),g(this,t,{skipDocArrays:!0}),this}return this.invalidate(t,new u.CastError("Object",e,t)),this}var R=void 0,F=-1===t.indexOf(".")?[t]:t.split(".");if("string"==typeof this.schema.aliases[F[0]]&&(F[0]=this.schema.aliases[F[0]]),"adhocOrUndefined"===j&&b){var L=void 0;for(y=0;y<F.length;++y){var U=F.slice(0,y+1).join(".");if(y+1<F.length&&"virtual"===this.schema.pathType(U))return P.set(t,e,this),this;if(null!=(R=this.schema.path(U))&&R instanceof c){L=!0;break}}if(null==R&&(R=E(this,t)),!L&&!R){if("throw"===b)throw new d(t);return this}}else{if("virtual"===j)return(R=this.schema.virtualpath(t)).applySetters(e,this),this;R=this.$__path(t)}var V=this._doc,q="";for(y=0;y<F.length-1;++y)V=V[F[y]],q+=(q.length>0?".":"")+F[y],V||(this.$set(q,{}),this.isSelected(q)||this.unmarkModified(q),V=this.$__getValue(q));var H=void 0;if(F.length<=1)H=t;else{for(y=0;y<F.length;++y){var Y=F.slice(0,y+1).join(".");if(null===this.get(Y,null,{getters:!1})){H=Y;break}}H||(H=t)}var z=null!=s.$__.$options.priorDoc?s.$__.$options.priorDoc.$__getValue(t):h?void 0:s.$__getValue(t);if(!R)return this.$__set(H,t,h,F,R,e,z),this;if(R.$isSingleNested&&null!=e&&a){e instanceof W&&(e=e.toObject({virtuals:!1,transform:!1}));var K=Object.keys(e),Q=!0,J=!1,G=void 0;try{for(var X,Z=K[Symbol.iterator]();!(Q=(X=Z.next()).done);Q=!0){var tt=X.value;this.$set(t+"."+tt,e[tt],h,n)}}catch(t){J=!0,G=t}finally{try{!Q&&Z.return&&Z.return()}finally{if(J)throw G}}return this}var et=!0;try{var rt=function(){if(null==R.options)return!1;if(!(e instanceof W))return!1;var t=e.constructor,r=R.options.ref;if(null!=r&&(r===t.modelName||r===t.baseModelName))return!0;var n=R.options.refPath;if(null==n)return!1;var i=e.get(n);return i===t.modelName||i===t.baseModelName}(),nt=!1;rt&&e instanceof W&&(this.populated(t,e._id,o({},I,e.constructor)),nt=!0);var it=void 0;if(R.options&&Array.isArray(R.options[this.schema.options.typeKey])&&R.options[this.schema.options.typeKey].length&&R.options[this.schema.options.typeKey][0].ref&&
/*!
 * ignore
 */
function(t,e){if(!Array.isArray(t))return!1;if(0===t.length)return!1;var r=!0,n=!1,i=void 0;try{for(var o,s=t[Symbol.iterator]();!(r=(o=s.next()).done);r=!0){var a=o.value;if(!(a instanceof W))return!1;var u=a.constructor.modelName;if(null==u)return!1;if(a.constructor.modelName!=e&&a.constructor.baseModelName!=e)return!1}}catch(t){n=!0,i=t}finally{try{!r&&s.return&&s.return()}finally{if(n)throw i}}return!0}(e,R.options[this.schema.options.typeKey][0].ref)&&(this.ownerDocument?(it=o({},I,e[0].constructor),this.ownerDocument().populated(this.$__fullPath(t),e.map(function(t){return t._id}),it)):(it=o({},I,e[0].constructor),this.populated(t,e.map(function(t){return t._id}),it)),nt=!0),null==this.schema.singleNestedPaths[t]&&(e=R.applySetters(e,this,!1,z)),R.$isMongooseDocumentArray&&Array.isArray(e)&&e.length>0&&null!=e[0]&&null!=e[0].$__&&null!=e[0].$__.populated){var ot=Object.keys(e[0].$__.populated),st=!0,at=!1,ut=void 0;try{for(var ct,lt=function(){var r=ct.value;s.populated(t+"."+r,e.map(function(t){return t.populated(r)}),e[0].$__.populated[r].options)},ft=ot[Symbol.iterator]();!(st=(ct=ft.next()).done);st=!0)lt()}catch(t){at=!0,ut=t}finally{try{!st&&ft.return&&ft.return()}finally{if(at)throw ut}}nt=!0}if(!nt&&this.$__.populated){if(Array.isArray(e)&&this.$__.populated[t])for(var ht=0;ht<e.length;++ht)e[ht]instanceof W&&(e[ht]=e[ht]._id);delete this.$__.populated[t]}this.$markValid(t)}catch(r){r instanceof u.StrictModeError&&r.isImmutableError?this.invalidate(t,r):this.invalidate(t,new u.CastError(R.instance,e,t,r)),et=!1}return et&&this.$__set(H,t,h,F,R,e,z),R.$isSingleNested&&(this.isDirectModified(t)||null==e)&&g(this,t),this},W.prototype.set=W.prototype.$set,W.prototype.$__shouldModify=function(t,e,r,n,i,o,s){return!!this.isNew||null==this.schema.singleNestedPaths[e]&&(void 0===o&&!this.isSelected(e)||!(void 0===o&&e in this.$__.activePaths.states.default)&&(!(this.populated(e)&&o instanceof W&&B(o._id,s))&&(!B(o,s||this.get(e))||!!(!r&&null!==o&&void 0!==o&&e in this.$__.activePaths.states.default&&B(o,i.getDefault(this,r))))))},W.prototype.$__set=function(t,e,n,i,o,s,a){V=V||r(25);var u=this;this.$__shouldModify(t,e,n,i,o,s,a)&&(this.markModified(t),U||(U=r(81)),s&&s.isMongooseArray&&(s._registerAtomic("$set",s),s.isMongooseDocumentArray&&s.forEach(function(t){t&&t.__parentArray&&(t.__parentArray=s)}),this.$__.activePaths.forEach(function(t){t.startsWith(e+".")&&u.$__.activePaths.ignore(t)})));for(var c=this._doc,l=0,f=i.length,h="";l<f;l++){var p=l+1===f;if(h+=h?"."+i[l]:i[l],q.has(i[l]))return;p?c instanceof Map?c.set(i[l],s):c[i[l]]=s:k.isPOJO(c[i[l]])?c=c[i[l]]:c[i[l]]&&c[i[l]]instanceof V?c=c[i[l]]:c[i[l]]&&c[i[l]].$isSingleNested?c=c[i[l]]:c[i[l]]&&Array.isArray(c[i[l]])?c=c[i[l]]:(c[i[l]]=c[i[l]]||{},c=c[i[l]])}},W.prototype.$__getValue=function(t){return k.getValue(t,this._doc)},W.prototype.$__setValue=function(t,e){return k.setValue(t,e,this._doc),this},W.prototype.get=function(t,e,r){var n=void 0;r=r||{},e&&(n=this.schema.interpretAsType(t,e,this.schema.options));var i=this.$__path(t);if(null==i&&(i=this.schema.virtualpath(t)),i instanceof c){var o=this.schema.virtualpath(t);null!=o&&(i=o)}var s=t.split("."),a=this._doc;if(i instanceof _){if(0===i.getters.length)return;return i.applyGetters(null,this)}"string"==typeof this.schema.aliases[s[0]]&&(s[0]=this.schema.aliases[s[0]]);for(var u=0,l=s.length;u<l;u++)a&&a._doc&&(a=a._doc),a=null==a?void 0:a instanceof Map?a.get(s[u]):u===l-1?k.getValue(s[u],a):a[s[u]];if(n&&(a=n.cast(a)),null!=i&&!1!==r.getters)a=i.applyGetters(a,this);else if(this.schema.nested[t]&&r.virtuals)return Q(this,k.clone(a)||{},{path:t});return a},
/*!
 * ignore
 */
W.prototype[F]=W.prototype.get,W.prototype.$__path=function(t){var e=this.$__.adhocPaths,r=e&&e.hasOwnProperty(t)?e[t]:null;return r||this.schema.path(t)},W.prototype.markModified=function(t,e){this.$__.activePaths.modify(t),null==e||this.ownerDocument||(this.$__.pathsToScopes[t]=e)},W.prototype.unmarkModified=function(t){this.$__.activePaths.init(t),delete this.$__.pathsToScopes[t]},W.prototype.$ignore=function(t){this.$__.activePaths.ignore(t)},W.prototype.directModifiedPaths=function(){return Object.keys(this.$__.activePaths.states.modify)},W.prototype.$isEmpty=function(t){var e={minimize:!0,virtuals:!1,getters:!1,transform:!1};if(arguments.length>0){var r=this.get(t);return null==r||"object"===(void 0===r?"undefined":i(r))&&(k.isPOJO(r)?function t(e){if(null==e)return!0;if("object"!==(void 0===e?"undefined":i(e))||Array.isArray(e))return!1;var r=!0;var n=!1;var o=void 0;try{for(var s,a=Object.keys(e)[Symbol.iterator]();!(r=(s=a.next()).done);r=!0){var u=s.value;if(!t(e[u]))return!1}}catch(t){n=!0,o=t}finally{try{!r&&a.return&&a.return()}finally{if(n)throw o}}return!0}(r):0===Object.keys(r.toObject(e)).length)}return 0===Object.keys(this.toObject(e)).length},W.prototype.modifiedPaths=function(t){t=t||{};var e=this;return Object.keys(this.$__.activePaths.states.modify).reduce(function(r,n){var o=n.split(".");if(r=r.concat(o.reduce(function(t,e,r){return t.concat(o.slice(0,r).concat(e).join("."))},[]).filter(function(t){return-1===r.indexOf(t)})),!t.includeChildren)return r;var s=e.get(n);if(null!=s&&"object"===(void 0===s?"undefined":i(s)))if(s._doc&&(s=s._doc),Array.isArray(s)){for(var a=s.length,u=0;u<a;++u)if(-1===r.indexOf(n+"."+u)&&(r.push(n+"."+u),null!=s[u]&&s[u].$__)){var c=s[u].modifiedPaths(),l=!0,f=!1,h=void 0;try{for(var p,d=c[Symbol.iterator]();!(l=(p=d.next()).done);l=!0){var y=p.value;r.push(n+"."+u+"."+y)}}catch(t){f=!0,h=t}finally{try{!l&&d.return&&d.return()}finally{if(f)throw h}}}}else Object.keys(s).filter(function(t){return-1===r.indexOf(n+"."+t)}).forEach(function(t){r.push(n+"."+t)});return r},[])},W.prototype.isModified=function(t,e){if(t){Array.isArray(t)||(t=t.split(" "));var r=e||this.modifiedPaths(),n=Object.keys(this.$__.activePaths.states.modify);return t.some(function(t){return!!~r.indexOf(t)})||t.some(function(t){return n.some(function(e){return e===t||t.startsWith(e+".")})})}return this.$__.activePaths.some("modify")},W.prototype.$isDefault=function(t){return t in this.$__.activePaths.states.default},W.prototype.$isDeleted=function(t){return 0===arguments.length?!!this.$__.isDeleted:(this.$__.isDeleted=!!t,this)},W.prototype.isDirectModified=function(t){return t in this.$__.activePaths.states.modify},W.prototype.isInit=function(t){return t in this.$__.activePaths.states.init},W.prototype.isSelected=function(t){if(this.$__.selected){if("_id"===t)return 0!==this.$__.selected._id;var e=Object.keys(this.$__.selected),r=e.length,n=null,i=void 0;if(1===r&&"_id"===e[0])return 0===this.$__.selected._id;for(;r--;)if("_id"!==(i=e[r])&&$(this.$__.selected[i])){n=!!this.$__.selected[i];break}if(null===n)return!0;if(t in this.$__.selected)return n;r=e.length;for(var o=t+".";r--;)if("_id"!==(i=e[r])){if(i.startsWith(o))return n||i!==o;if(o.startsWith(i+"."))return n}return!n}return!0},W.prototype.isDirectSelected=function(t){if(this.$__.selected){if("_id"===t)return 0!==this.$__.selected._id;var e=Object.keys(this.$__.selected),r=e.length,n=null,i=void 0;if(1===r&&"_id"===e[0])return 0===this.$__.selected._id;for(;r--;)if("_id"!==(i=e[r])&&$(this.$__.selected[i])){n=!!this.$__.selected[i];break}return null===n||(t in this.$__.selected?n:!n)}return!0},W.prototype.validate=function(t,e,r){var n=this,i=void 0;return this.$op="validate",null!=this.ownerDocument||(this.$__.validating?i=new h(this,{parentStack:e&&e.parentStack,conflictStack:this.$__.validating.stack}):this.$__.validating=new h(this,{parentStack:e&&e.parentStack})),"function"==typeof t?(r=t,e=null,t=null):"function"==typeof e&&(r=e,e=t,t=null),m(r,function(r){if(null!=i)return r(i);n.$__validate(t,e,function(t){n.$op=null,r(t)})},this.constructor.events)},W.prototype.$__validate=function(t,r,n){var o=this;"function"==typeof t?(n=t,r=null,t=null):"function"==typeof r&&(n=r,r=null);var s=r&&"object"===(void 0===r?"undefined":i(r))&&"validateModifiedOnly"in r,a=void 0;a=s?!!r.validateModifiedOnly:this.schema.options.validateModifiedOnly;var c=this,l=function(){var t=o.$__.validationError;if(o.$__.validationError=void 0,a&&null!=t){var e=Object.keys(t.errors),r=!0,n=!1,i=void 0;try{for(var s,l=e[Symbol.iterator]();!(r=(s=l.next()).done);r=!0){var f=s.value;o.isModified(f)||delete t.errors[f]}}catch(t){n=!0,i=t}finally{try{!r&&l.return&&l.return()}finally{if(n)throw i}}0===Object.keys(t.errors).length&&(t=void 0)}if(o.$__.cachedRequired={},o.emit("validate",c),o.constructor.emit("validate",c),o.$__.validating=null,t){for(var h in t.errors)!o[M]&&t.errors[h]instanceof u.CastError&&o.invalidate(h,t.errors[h]);return t}},f=z(this),h=a?f[0].filter(function(t){return o.isModified(t)}):f[0],p=f[1];if(Array.isArray(t)&&(h=K(h,t)),0===h.length)return e.nextTick(function(){var t=l();if(t)return c.schema.s.hooks.execPost("validate:error",c,[c],{error:t},function(t){n(t)});n(null,c)});for(var d={},v=0,_=function(){var t=l();if(t)return c.schema.s.hooks.execPost("validate:error",c,[c],{error:t},function(t){n(t)});n(null,c)},m=function(t){null==t||d[t]||(d[t]=!0,v++,e.nextTick(function(){var e=c.schema.path(t);if(!e)return--v||_();if(c.$isValid(t)){var r=c.$__getValue(t),n=void 0;null==r&&(n=c.populated(t))&&(r=n);var i=t in c.$__.pathsToScopes?c.$__.pathsToScopes[t]:c,o={skipSchemaValidators:p[t],path:t};e.doValidate(r,function(r){if(r&&(!e.$isMongooseDocumentArray||r.$isArrayValidatorError)){if(e.$isSingleNested&&r instanceof y&&!1===e.schema.options.storeSubdocValidationError)return--v||_();c.invalidate(t,r,void 0,!0)}--v||_()},i,o)}else--v||_()}))},g=h.length,b=0;b<g;++b)m(h[b])},W.prototype.validateSync=function(t,e){var r=this,n=this,o=void 0;o=e&&"object"===(void 0===e?"undefined":i(e))&&"validateModifiedOnly"in e?!!e.validateModifiedOnly:this.schema.options.validateModifiedOnly,"string"==typeof t&&(t=t.split(" "));var s=z(this),a=o?s[0].filter(function(t){return r.isModified(t)}):s[0],c=s[1];Array.isArray(t)&&(a=K(a,t));var l={};a.forEach(function(t){if(!l[t]){l[t]=!0;var e=n.schema.path(t);if(e&&n.$isValid(t)){var r=n.$__getValue(t),i=e.doValidateSync(r,n,{skipSchemaValidators:c[t],path:t});if(i&&(!e.$isMongooseDocumentArray||i.$isArrayValidatorError)){if(e.$isSingleNested&&i instanceof y&&!1===e.schema.options.storeSubdocValidationError)return;n.invalidate(t,i,void 0,!0)}}}});var f=n.$__.validationError;if(n.$__.validationError=void 0,n.emit("validate",n),n.constructor.emit("validate",n),f)for(var h in f.errors)f.errors[h]instanceof u.CastError&&n.invalidate(h,f.errors[h]);return f},W.prototype.invalidate=function(t,e,r,n){if(this.$__.validationError||(this.$__.validationError=new y(this)),!this.$__.validationError.errors[t])return e&&"string"!=typeof e||(e=new v({path:t,message:e,type:n||"user defined",value:r})),this.$__.validationError===e?this.$__.validationError:(this.$__.validationError.addError(t,e),this.$__.validationError)},W.prototype.$markValid=function(t){this.$__.validationError&&this.$__.validationError.errors[t]&&(delete this.$__.validationError.errors[t],0===Object.keys(this.$__.validationError.errors).length&&(this.$__.validationError=null))},W.prototype.$isValid=function(t){return!this.$__.validationError||!this.$__.validationError.errors[t]},W.prototype.$__reset=function(){var t=this;return L||(L=r(17)),this.$__.activePaths.map("init","modify",function(e){return t.$__getValue(e)}).filter(function(t){return t&&t instanceof Array&&t.isMongooseDocumentArray&&t.length}).forEach(function(e){for(var r=e.length;r--;){var n=e[r];n&&n.$__reset()}t.$__.activePaths.init(e.$path()),e[D]={}}),this.$__.activePaths.map("init","modify",function(e){return t.$__getValue(e)}).filter(function(t){return t&&t.$isSingleNested}).forEach(function(e){e.$__reset(),t.$__.activePaths.init(e.$basePath)}),this.$__dirty().forEach(function(t){var e=t.value;e&&e[D]&&(e[D]={})}),this.$__.activePaths.clear("modify"),this.$__.activePaths.clear("default"),this.$__.validationError=void 0,this.errors=void 0,t=this,this.schema.requiredPaths().forEach(function(e){t.$__.activePaths.require(e)}),this},W.prototype.$__dirty=function(){var t=this,e=this.$__.activePaths.map("modify",function(e){return{path:e,value:t.$__getValue(e),schema:t.$__path(e)}});(e=e.concat(this.$__.activePaths.map("default",function(e){if("_id"!==e&&null!=t.$__getValue(e))return{path:e,value:t.$__getValue(e),schema:t.$__path(e)}}))).sort(function(t,e){return t.path<e.path?-1:t.path>e.path?1:0});var r=[],n=void 0,i=void 0;return e.forEach(function(t){t&&(null==n||0!==t.path.indexOf(n)?(n=t.path+".",r.push(t),i=t):null!=i&&null!=i.value&&null!=i.value[D]&&i.value.hasAtomics()&&(i.value[D]={},i.value[D].$set=i.value))}),i=n=null,r},W.prototype.$__setSchema=function(t){t.plugin(A,{deduplicate:!0}),b(t.tree,this,void 0,t.options);var e=!0,r=!1,n=void 0;try{for(var i,o=Object.keys(t.virtuals)[Symbol.iterator]();!(e=(i=o.next()).done);e=!0){var s=i.value;t.virtuals[s]._applyDefaultGetters()}}catch(t){r=!0,n=t}finally{try{!e&&o.return&&o.return()}finally{if(r)throw n}}this.schema=t,this[R]=t},W.prototype.$__getArrayPathsToValidate=function(){return L||(L=r(17)),this.$__.activePaths.map("init","modify",function(t){return this.$__getValue(t)}.bind(this)).filter(function(t){return t&&t instanceof Array&&t.isMongooseDocumentArray&&t.length}).reduce(function(t,e){return t.concat(e)},[]).filter(function(t){return t})},W.prototype.$__getAllSubdocs=function(){L||(L=r(17)),V=V||r(25);var t=this;return Object.keys(this._doc).reduce(function(e,r){return function t(e,r,n){var i=e;return n&&(i=e instanceof W&&e[R].paths[n]?e._doc[n]:e[n]),i instanceof V?r.push(i):i instanceof Map?r=Array.from(i.keys()).reduce(function(e,r){return t(i.get(r),e,null)},r):i&&i.$isSingleNested?(r=Object.keys(i._doc).reduce(function(e,r){return t(i._doc,e,r)},r)).push(i):i&&i.isMongooseDocumentArray?i.forEach(function(e){e&&e._doc&&(r=Object.keys(e._doc).reduce(function(r,n){return t(e._doc,r,n)},r),e instanceof V&&r.push(e))}):i instanceof W&&i.$__isNested&&(r=Object.keys(i).reduce(function(e,r){return t(i,e,r)},r)),r}(t,e,r)},[])},W.prototype.$__handleReject=function(t){this.listeners("error").length?this.emit("error",t):this.constructor.listeners&&this.constructor.listeners("error").length?this.constructor.emit("error",t):this.listeners&&this.listeners("error").length&&this.emit("error",t)},W.prototype.$toObject=function(t,e){var r={transform:!0,flattenDecimals:!0},i=e?"toJSON":"toObject",o=S(this,"constructor.base.options."+i,{}),s=S(this,"schema.options",{});r=k.options(r,T(o)),r=k.options(r,T(s[i]||{})),"flattenMaps"in(t=k.isPOJO(t)?T(t):{})||(t.flattenMaps=r.flattenMaps);var a=void 0;a=null!=t.minimize?t.minimize:null!=r.minimize?r.minimize:s.minimize;var u=Object.assign(k.clone(t),{_isNested:!0,json:e,minimize:a});if(k.hasUserDefinedProperty(t,"getters")&&(u.getters=t.getters),k.hasUserDefinedProperty(t,"virtuals")&&(u.virtuals=t.virtuals),(t.depopulate||S(t,"_parentOptions.depopulate",!1))&&t._isNested&&this.$__.wasPopulated)return T(this._id,u);(t=k.options(r,t))._isNested=!0,t.json=e,t.minimize=a,u._parentOptions=t,u._skipSingleNestedGetters=!0;var c=Object.assign({},u);c._skipSingleNestedGetters=!1;var l=t.transform,f=T(this._doc,u)||{};t.getters&&(!function(t,e,r){var n=t.schema,i=Object.keys(n.paths),o=i.length,s=void 0,a=t._doc,u=void 0;if(!a)return e;for(;o--;){var c=(s=i[o]).split("."),l=c.length,f=l-1,h=e,p=void 0;if(a=t._doc,t.isSelected(s))for(var d=0;d<l;++d){if(p=c[d],u=a[p],d===f){var y=t.get(s);h[p]=T(y,r)}else{if(null==u){p in a&&(h[p]=u);break}h=h[p]||(h[p]={})}a=u}}}
/*!
...
/*!
 * Module dependencies.
 */var n=r(16),i=r(5),o=r(3);function s(t,e,r,s,a){var u=o.inspect(e);(u=u.replace(/^'/,'"').replace(/'$/,'"')).startsWith('"')||(u='"'+u+'"'),"string"==typeof i(a,"options.cast",null)&&(this.messageFormat=a.options.cast),this.stringValue=u,this.kind=t,this.value=e,this.path=r,this.reason=s,n.call(this,this.formatMessage()),this.name="CastError",Error.captureStackTrace?Error.captureStackTrace(this):this.stack=(new Error).stack}
/*!
 ...
 * Module dependencies.
 */
var i="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t};function o(t,e,r){return e in t?Object.defineProperty(t,e,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[e]=r,t}var s=r(18).EventEmitter,a=r(134),u=r(16),c=r(7),l=r(9),f=r(135),h=r(53),p=r(73),d=r(136),y=r(138),v=r(0).arrayParentSymbol,_=r(5),m=r(139),g=r(74),b=r(140),w=r(44),O=r(14).get().ReadPreference,S=r(51),E=r(3),A=r(2),$=r(141),j=void 0,x=r(142).middlewareFunctions,N=r(75).middlewareFunctions,P=x.concat(N).reduce(function(t,e){return t.add(e)},new Set),k=0;function T(t,e){if(!(this instanceof T))return new T(t,e);if(this.obj=t,this.paths={},this.aliases={},this.subpaths={},this.virtuals={},this.singleNestedPaths={},this.nested={},this.inherits={},this.callQueue=[],this._indexes=[],this.methods={},this.methodOptions={},this.statics={},this.tree={},this.query={},this.childSchemas=[],this.plugins=[],this.$id=++k,this.s={hooks:new a},this.options=this.defaultOptions(e),Array.isArray(t)){var r=!0,n=!1,i=void 0;try{for(var o,s=t[Symbol.iterator]();!(r=(o=s.next()).done);r=!0){var u=o.value;this.add(u)}}catch(t){n=!0,i=t}finally{try{!r&&s.return&&s.return()}finally{if(n)throw i}}}else t&&this.add(t);var c=t&&t._id&&A.isObject(t._id);!this.paths._id&&!this.options.noId&&this.options._id&&!c&&p(this),this.setupTimestamp(this.options.timestamps)}
/*!
...
/*!
 * Module exports.
 */e.Array=r(81),e.Buffer=r(84),e.Document=e.Embedded=r(25),e.DocumentArray=r(17),e.Decimal128=r(19),e.ObjectId=r(12),e.Map=r(86),e.Subdocument=r(87)},function(t,e,r){"use strict";var n=r(0).documentSchemaSymbol,i=r(5),o=r(0).getSymbol,s=r(2),a=void 0;
/*!
 * Compiles schemas.
 */
...
/*!
 * Module dependencies.
 */var n=r(6),i=r(171),o=!1;t.exports=function(){return o?i:n},
/*!
 * ignore
 */
 ...
 * Module requirements.
 */
var n=r(4),i=r(145),o=r(7),s=r(146),a=r(78),u=r(2),c=r(0).populateModelSymbol,l=o.CastError,f=void 0;function h(t,e){o.call(this,t,e,"Number")}
/*!
 * ignore
 */
 ...
 * Module dependencies.
 */
var n=r(7),i=r(4),o=r(144),s=r(76),a=r(2),u=r(0).populateModelSymbol,c=n.CastError,l=void 0;function f(t,e){this.enumValues=[],this.regExp=null,n.call(this,t,e,"String")}
/*!
 * ignore
 */
 ...
 * Module dependencies.
 */
var n="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},i=r(84),o=r(157),s=r(7),a=r(78),u=r(2),c=r(0).populateModelSymbol,l=i.Binary,f=s.CastError,h=void 0;function p(t,e){s.call(this,t,e,"Buffer")}
/*!
 * ignore
 */
...
/*!
 * Module requirements.
 */var n=r(4),i=r(159),o=r(7),s=r(160),a=r(2),u=o.CastError;function c(t,e){o.call(this,t,e,"Date")}
/*!
 * Date Query casting.
 *
 * @api private
 ...
 */
function n(){return null!=this._id?String(this._id):null}t.exports=function(t){!t.paths.id&&!t.options.noVirtualId&&t.options.id&&t.virtual("id").get(n)}},function(t,e,r){"use strict";var n=r(91);
/*!
 * ignore
